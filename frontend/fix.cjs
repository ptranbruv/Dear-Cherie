...
content = content.split('bg-red-200/20').join('bg-[#AF2E38]');

content = content.split('"https://placehold.co/120x160"').join('"/images/CustomizeHoa/f9080b8321ae7c9df6ca5dda46cd96397c18d393.png"');
content = content.split('"https://placehold.co/146x194"').join('"/images/CustomizeHoa/4a11fcc5f36a3a414182283a738de97e74b7df02.png"');
content = content.split('"https://placehold.co/127x169"').join('"/images/CustomizeHoa/2bda025de717bd952aa48885fdfb0362789895da.png"');
content = content.split('"https://placehold.co/137x182"').join('"/images/CustomizeHoa/7f5795ac3c5d0413eb5ce56faf7b73904283c23d.png"');
...
const regex = /<div className=\"w-\\[1131px\\] h-28 left-\\[150px\\] top-\\[135px\\] absolute overflow-hidden\">[\\s\\S]*?<div className=\"w-80 h-24 left-\\[1000px\\] top-\\[830px\\] absolute overflow-hidden\">/;
